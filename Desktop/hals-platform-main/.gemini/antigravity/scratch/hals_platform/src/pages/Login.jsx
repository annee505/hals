...
const Login = () => {
    ...
    const handleGoogleLogin = () => {
        ...
        try {
            const user = authService.googleLogin(mockGoogleProfile);

            // Check if profile is complete — returning users go straight to dashboard
            if (user.profile && user.profile.goal && user.profile.hobbies) {
                navigate('/dashboard');
            } else {
                navigate('/profile-setup');
            }
